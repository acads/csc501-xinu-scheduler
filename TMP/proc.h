...
#define PRNEWPA1        '\011'          /* new process in Linux sched   */
...
struct	pentry	{
	...
	int	pwaitret;
        ...
        unsigned long pticks;           /* # of CPU ticks used          */
        unsigned long pquant;           /* assigned quantum value       */
        unsigned long pctr;             /* unused quantum value         */
        unsigned long pgood;            /* goodness of the process      */
        unsigned long pins;             /* # of times run               */
        unsigned long pouts;            /* # of times ctxsw'd           */
};
